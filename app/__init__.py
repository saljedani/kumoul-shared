...
def create_app(config=None):
    ...
    for bp in (auth_bp, dashboard_bp, files_bp, folders_bp,
               sharing_bp, admin_bp, search_bp, notifications_bp, company_bp):
...
format_bytes_util = _fmt_bytes   # backward compat for init_db.py
